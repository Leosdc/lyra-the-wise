...
# ===== ESTRUTURAS DE FICHAS POR SISTEMA =====

ESTRUTURAS_FICHAS = {
    "dnd5e": {
        "secoes": ["basico", "atributos", "recursos", "combate", "perícias", "equipamento", "magia", "historia"],
        "campos": {
            ...
            "perícias": ["Acrobacia", "Arcanismo", "Atletismo", "Atuação", "Blefar", "Furtividade", "História", "Intimidação", "Intuição", "Investigação", "Lidar com Animais", "Medicina", "Natureza", "Percepção", "Persuasão", "Prestidigitação", "Religião", "Sobrevivência"],
    ...
    "pathfinder": {
        "secoes": ["basico", "atributos", "recursos", "combate", "perícias", "equipamento", "magia", "talentos", "historia"],
        "campos": {
            ...
            "perícias": ["Acrobacia", "Arcanismo", "Atletismo", "Artesanato", "Diplomacia", "Enganação", "Furtividade", "Intimidação", "Conhecimento", "Medicina", "Natureza", "Ocultismo", "Performance", "Religião", "Sociedade", "Sobrevivência", "Ladinagem"],
    ...
    "cthulhu": {
        "secoes": ["basico", "características", "recursos", "combate", "perícias", "equipamento", "historia"],
        "campos": {
            "basico": ["Nome", "Ocupação", "Idade", "Sexo", "Residência", "Local de Nascimento"],
            "características": ["FOR (Força)", "CON (Constituição)", "TAM (Tamanho)", "DES (Destreza)", "APA (Aparência)", "INT (Inteligência)", "POD (Poder)", "EDU (Educação)", "SOR (Sorte)"],
    ...
    "shadowrun": {
        "secoes": ["basico", "atributos", "recursos", "perícias", "equipamento", "magia_ressonância", "historia"],
        "campos": {
            ...
            "perícias": ["Armas de Fogo", "Armas Brancas", "Atletismo", "Briga", "Condução", "Furtividade", "Percepção", "Computadores", "Cibercombate", "Hacking Eletrônico", "Software", "Conjuração", "Encantamento", "Invocação", "Banimento", "Contrabandos", "Etiqueta", "Intimidação", "Liderança", "Negociação", "Medicina"],
            "equipamento": ["Cyberware", "Bioware", "Armas", "Armadura", "Equipamento Matriz", "Veículos", "Drones", "Nuyen"],
            "magia_ressonância": ["Tradição Mágica", "Feitiços", "Formas de Conjuração", "Espíritos Vinculados", "Sprites Registrados", "Formas Complexas"],
            "historia": ["Conceito", "Contatos", "Inimigos", "História", "Aparência"]
        }
    },
    
    "fate_core": {
        "secoes": ["basico", "aspectos", "perícias", "façanhas", "recursos", "consequências"],
        "campos": {
            "basico": ["Nome", "Descrição", "Campanha", "Nível de Poder"],
            "aspectos": ["Conceito", "Dificuldade", "Aspecto 3", "Aspecto 4", "Aspecto 5"],
            "perícias": ["Lista de Perícias (Nível Ótimo +4)", "Nível Bom +3", "Nível Razoável +2", "Nível Regular +1"],
            "façanhas": ["Façanha 1", "Façanha 2", "Façanha 3"],
            "recursos": ["Recarga de Pontos de Destino", "Pontos de Destino Atuais", "Estresse Físico", "Estresse Mental"],
            "consequências": ["Consequência Suave (2)", "Consequência Moderada (4)", "Consequência Severa (6)"]
        }
    },
    
    "dungeon_world": {
        "secoes": ["basico", "atributos", "movimentos", "recursos", "equipamento", "vinculos", "aparência"],
        "campos": {
            ...
            "aparência": ["Olhos", "Corpo", "Roupas", "Descrição"]
        }
    },
    
    "blades": {
        "secoes": ["basico", "ações", "atributos_resistência", "recursos", "trauma_vice", "equipamento", "contatos"],
        "campos": {
            "basico": ["Nome", "Playbook", "Herança", "Background", "Conceito"],
            "ações": ["Enganar", "Finesse", "Caçar", "Esgueirar", "Comandar", "Consorciar", "Manipular", "Estudar", "Pesquisar", "Reparar", "Demolir", "Desarmar"],
            "atributos_resistência": ["Insight", "Prowess", "Resolve"],
    ...
    "numenera": {
        "secoes": ["basico", "pools", "perícias", "habilidades", "equipamento", "cyphers", "historia"],
        "campos": {
            ...
            "perícias": ["Treinado em", "Especializado em", "Inabilidade em"],
...
def get_estrutura_ficha(sistema_key: str):
    ...
    # Estrutura genérica para sistemas sem estrutura definida
    return {
