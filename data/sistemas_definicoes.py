...
SISTEMAS_DISPONIVEIS = {
    ...
    "shadowdemon": {
        ...
        "descricao": "Magia perigosa e ação manchado: um mundo que cambaleia rumo ao fim – sobreviva, se puder.",
    ...
    "ars_magica": {
        ...
        "descricao": "Colégios de magos e eras medievais: estudo, laboratório e poder hermético moldam a Europa Mística.",
